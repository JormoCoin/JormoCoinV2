...
//
// The large premine is to pay people back for all there mining of JormoV1 which was shutdown.
...
const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 600000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 600000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 106;
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(1000000000); // This is only to pay people back for the original Jormo's shutdown!
...
const size_t   DIFFICULTY_WINDOW_V1                          = 150;
const size_t   DIFFICULTY_WINDOW_V2                          = 150;
...
const char     CRYPTONOTE_NAME[]                             = "jormocoin";
...
const int      P2P_DEFAULT_PORT                              =  12331;
const int      RPC_DEFAULT_PORT                              =  12332;
